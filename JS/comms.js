...
var log, WebSocket;
var wss1 = new WebSocket('ws://localhost:12345');    // var for test, we may want to redefine
var wss2 = new WebSocket('ws://localhost:12345');    // var for test, we may want to redefine
