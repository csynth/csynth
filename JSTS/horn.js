...
export class Horn {
    ...
    */
    ...
    ;
    $sweep(o, genes, s) { return o.processTran("twr(x,y, MM0, 0.);", s, [["sweep", { k: 90 }, 0, 180, u, 0.1, "sweep for horn", "geom", "free", "k"]], {}, genes); }
    ;
    ...
    */
     ...
     * num is the cumulative (product) number of instances of this
     was renderh */
    _compileh2a(genes, uniformsp, rendertarget, hset, key, num, parentHornid, subtype) {
...
export class HornSet {
    ...
    static monitorSynthdef() {
        ...
        if (hset) {
            ...
            if (hset.synthCode === mutSynthPendingCode)
    ...
    */
    ...
    /*^^^async*/ setuphorn(tranrule, genes) {
    ...
    _compilehsI(tranrule, genes) {
        ...
        this._saveposset = {}; // set of savepos done, with true if not yet resolved
        if (!genes._basetranrule)
            genes._basetranrule = tranrule;
