...
Hammer.utils = {
  ...
  getScale: function getScale(start, end) {
    // need two fingers...
    if(!V.BypassPinch && start.length >= 2 && end.length >= 2) {
  ...
  handler  : function transformGesture(ev, inst) {
    ...
    switch(ev.eventType) {
      ...
      case Hammer.EVENT_MOVE:
        ...
        inst.trigger(this.name, ev); // basic transform even
...
//PJT: I was having problems with 'hammer undefined' when we try to use it in Electron on Windows (10, FWIW)
// It was invoking the "commonjs" version, which was not useful in the context we are trying to use the code in.
window.Hammer = Hammer; //XXX: very hacky hard-coding of the condition we actually want.
/*
// AMD export
if(typeof define == 'function' && define.amd) {
//    alert("hammer AMD export");
  define(function(){
    return Hammer;
  });
}
...
//    alert("hammer commonjs export");
  module.exports = Hammer;
}
// browser export
else {
//    alert("hammer browser export");
