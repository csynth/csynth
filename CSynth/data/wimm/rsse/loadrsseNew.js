...
const {G, springdemo, DNASprings, CSynth, V, customLoadDone, nomess, setAllLots, W, GX} = window;
springdemo( {
    minid: 32001350,
    res: 250,
    numInstances: 1200,
...
W.customSettings = () => {
    ...
    G.springforce = 0;      // default for all pairwise springs: new 30/9/18
    G.xyzforce = 1e-6;      // low for v slow transition needed for all pairwise springs: new 30/9/18
    G.pushapartforce = 0;   // rely on xyzsprings to get right answer
    G.pushapartlocalforce=0.2   // default
